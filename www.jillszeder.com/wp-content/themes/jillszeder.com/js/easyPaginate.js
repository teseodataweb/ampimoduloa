    ...
    return this.each (function (instance) {        
        ...
        var displayNav = function() {
            ...
            $(elSelector + ' .easyPaginateNav a.page,'
                ...
                if($(this).attr('rel') == 1){
                    jQuery('.ip-fp-pagi-inner span .prev').hide(); 
                }else{
                    jQuery('.ip-fp-pagi-inner span .prev').show(); 
                }
                if(lastpage == plugin.settings.pages || lastpage > plugin.settings.pages){
                    jQuery('.ip-fp-pagi-inner span .next').hide(); 
                }else{
                    jQuery('.ip-fp-pagi-inner span .next').show();
                }

                if( $(this).attr('rel') == plugin.settings.pages ){
                    var clast = parseInt($(this).attr('rel')) + 1 ;
                    jQuery('.ip-fp-pagi-inner span a').removeClass('current'); 
                    jQuery('.ip-fp-pagi-inner label a').removeClass('current'); 
                    jQuery('.ip-fp-pagi-inner span:eq('+ clast  +') a').addClass('current');  
                }         
            });
            ...
            $(elSelector + ' .easyPaginateNav a.prev').on('click', function(e) {
                ...
                // }if(page == plugin.settings.pages - 1){
                ...
                if(page > 6){
                    jQuery('.ip-fp-pagi-inner span').removeClass('hide');
                    jQuery('.ip-fp-pagi-inner label').hide();
            ...
            $(elSelector + ' .easyPaginateNav a.next').on('click', function(e) {
                ...
                // if(page > 6){
                //     jQuery('.ip-fp-pagi-inner span:eq(6)').html('<a href="#'+plugin.settings.hashPage+':'+page+'" title="Page '+page+'" rel="'+page+'" class="page">'+page+'</a>');
                //     jQuery('.ip-fp-pagi-inner span:eq(0)').show();
                // }if(page == plugin.settings.pages){

                //     jQuery('.ip-fp-pagi-inner span:eq(7)').hide();
                //     jQuery('.ip-fp-pagi-inner label').hide();
                // }else{
                //     jQuery('.ip-fp-pagi-inner span:last-child').show();
                //     jQuery('.ip-fp-pagi-inner label').show();                    
                // }
                if(page == 1){
                    jQuery('.ip-fp-pagi-inner span .prev').hide(); 
                ...
                if(page > 6){
                    ...
                    var last = page + 1;
                    jQuery('.ip-fp-pagi-inner span:eq('+last+') a').addClass('current');
                    jQuery('.ip-fp-pagi-inner label').hide();
                    jQuery('.ip-fp-pagi-inner span .next').hide();
